- [1. 作用域、this、闭包、执行上下文](#1-作用域this闭包执行上下文)
  ...
  - [1.11. 什么是js的闭包？有什么作用，用闭包写个单例模式](#111-什么是js的闭包有什么作用用闭包写个单例模式)
  - [1.12. 为什么闭包函数能够访问其他函数的作用域?](#112-为什么闭包函数能够访问其他函数的作用域)
  - [1.13. 写一个自执行函数](#113-写一个自执行函数)
  - [1.14. 判断打印顺序](#114-判断打印顺序)
