...
- [类型和变量](#)
  - [javascript 有哪几种数据类型](#javascript)
  - [javascript 按照存储方式区分变量类型？](#javascript)
  - [引用类型的特点？](#)
  - [typeof 能区分哪些类型？](#typeof)
  - [如何强制类型转换？](#)
  - [什么情况下会发生隐式类型转换？](#)
  - [隐式类型转换的常见应用？](#)
  ...
  - [如何理解 JSON？](#如何理解-JSON)
  - [函数和数组可以有属性吗？](#)
  - [!!()是false的情况有哪几种？ ](#!!()是false)
  - [===运算符判断相等的流程是怎样的](#)
  - [==运算符判断相等的流程是怎样的](#)
  - [对象到字符串的转换步骤](#)
  - [对象到数字的转换步骤](#)
  - [判断 [] == false 的输出是什么？](#判断-[]-==-false)
  - [判断 {} == false 的输出是什么？](#判断-{}-==-false)
  - [判断 [] == ![] 的输出是什么？](#)
  - [判断 {} == !{} 的输出是什么？](#)
  - [判断 console.log( [] ? true : false) 的输出是什么？](#判断-console.log(-[]-?-true-:-false)
- [原型和原型链](#)
  - [构造函数的特点](#)
  - [只有对象都有构造函数吗？](#)
...
- [作用域 闭包 执行上下文](#)
  ...
  - [js 的作用域有哪些？](#js)
  - [什么是自由变量和作用域链？](#)
  - [什么是js的闭包？有什么作用，用闭包写个单例模式](#什么是js)
  - [写一个自执行函数](#)
- [异步和单线程](#)
  - [前端使用异步的场景？](#)
  - [同步和异步的区别是什么？分别举一个同步和异步的例子](#)
  - [css 是同步执行还是异步的？](#css)
  - [函数方法中，forEach 和 map 的区别？](#函数方法中，forEach-和-map)
- [日期 Math 数组 对象](#日期-Math)
  - [获取随机数，要求是长度一致的字符串格式](#)
- [JS Web API](#JS-Web-API)
  - [DOM是哪种基本数据结构](#DOM)
  - [DOM节点的Attribute和property有何区别？](#DOM节点的Attribute和property)
  - [什么是BOM？](#什么是BOM)
