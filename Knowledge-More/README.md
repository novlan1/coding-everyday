...
- [2. SSL证书](#2-ssl证书)
  - [2.1.TTL](#21ttl)
  - [2.2.SSL证书验证](#22ssl证书验证)
  - [2.3.Chrome 浏览器显示“网站连接不安全”](#23chrome-浏览器显示网站连接不安全)
  - [2.4.SSL证书分类](#24ssl证书分类)
- [3. 后端任务](#3-后端任务)
...
- [8. 微服务架构](#8-微服务架构)
- [9. 单体架构](#9-单体架构)
  - [9.1.SOA和微服务架构的区别？](#91soa和微服务架构的区别)
- [10. C/S架构和B/S架构区别](#10-cs架构和bs架构区别)
- [11. `1GB`约等于`10亿个Byte`](#11-1gb约等于10亿个byte)
- [12. 命令式编程和声明式编程](#12-命令式编程和声明式编程)
- [13. 谷歌浏览器页面提示翻译的原因](#13-谷歌浏览器页面提示翻译的原因)
- [14. `ie=edge`的意思](#14-ieedge的意思)
- [15. `gt`, `lt`, `gte`, `lte`的含义](#15-gt-lt-gte-lte的含义)
- [16. SSR相关](#16-ssr相关)
  - [16.1.CSR（客户端渲染）过程：](#161csr客户端渲染过程)
  - [16.2.React的SSR：](#162react的ssr)
  - [16.3.SSR和CSR对比：](#163ssr和csr对比)
  - [16.4.Js解析：](#164js解析)
  - [16.5.package.json中：](#165packagejson中)
  - [16.6.同构的概念：](#166同构的概念)
  - [16.7.数据的注水和脱水：](#167数据的注水和脱水)
...
- [23. T+0](#23-t0)
- [24. 网络存储的方式](#24-网络存储的方式)
- [25. 技术优化](#25-技术优化)
- [26. 如果需要手动写动画，你认为最小时间间隔是多久，为什么？](#26-如果需要手动写动画你认为最小时间间隔是多久为什么)
- [27. 扫描二维码登录网页是什么原理，前后两个事件是如何联系的？](#27-扫描二维码登录网页是什么原理前后两个事件是如何联系的)
- [28. 微信小程序](#28-微信小程序)
  - [28.1.`switchTab`和`navigateTo`方法](#281switchtab和navigateto方法)
- [29. 使用Navicat连接阿里云服务器上的MySQL数据库](#29-使用navicat连接阿里云服务器上的mysql数据库)
- [30. 百度云虚拟主机添加SSL证书](#30-百度云虚拟主机添加ssl证书)
- [31. 股票代码规则](#31-股票代码规则)
- [32. RN](#32-rn)
- [33. 天使投资人、ABC轮融资](#33-天使投资人abc轮融资)
- [34. 突发性能实例与通用型的区别](#34-突发性能实例与通用型的区别)
- [35. 九宫格拼图游戏](#35-九宫格拼图游戏)
  - [35.1. 如何判断随机的图片是否可解？](#351-如何判断随机的图片是否可解)
  - [35.2. 如果随机出来的图片不可解，是不是要重新随机，直到它可解？](#352-如果随机出来的图片不可解是不是要重新随机直到它可解)
- [36. 下单柜台面板](#36-下单柜台面板)
- [37. m3u8](#37-m3u8)
- [38. 面试](#38-面试)
  - [38.1.面试注意事项](#381面试注意事项)
  - [38.2.行为面试题怎么解答](#382行为面试题怎么解答)
  - [38.3.面试项目常见问题：](#383面试项目常见问题)
  - [38.4.面试官：你还有什么要问我的吗？](#384面试官你还有什么要问我的吗)
...
#### 28.1.`switchTab`和`navigateTo`方法
...
2. [WebAssembly 系列（二）：JavaScript Just-in-time (JIT) 工作原理](https://blog.csdn.net/chenqiuge1984/article/details/80128715)
3. [图说 WebAssembly](https://www.zcfy.cc/article/an-abridged-cartoon-introduction-to-webassembly-ndash-smashing-magazine)
