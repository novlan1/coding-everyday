...
- [12. JS实现异步的几种方式](#12-js实现异步的几种方式)
- [13. 构造json参数时key需要加引号吗？](#13-构造json参数时key需要加引号吗)
- [14. 数组去重的方法](#14-数组去重的方法)
- [15. 将一个类数组对象转化为数组的几种方法](#15-将一个类数组对象转化为数组的几种方法)
- [16. 什么是JS Engine（JS引擎）？](#16-什么是js-enginejs引擎)
  - [16.1. JS引擎中栈和堆](#161-js引擎中栈和堆)
- [17. 对称加密和非对称加密算法](#17-对称加密和非对称加密算法)
  - [17.1. 可解密：](#171-可解密)
  - [17.2. 不可解密：](#172-不可解密)
- [18. 如何在选择图片后，不经后端而显示预览图片？](#18-如何在选择图片后不经后端而显示预览图片)
- [19. Blob 和 ArrayBuffer](#19-blob-和-arraybuffer)
  - [19.1. Blob](#191-blob)
  - [19.2. ArrayBuffer](#192-arraybuffer)
  - [19.3. Blob 和 ArrayBuffer 的区别](#193-blob-和-arraybuffer-的区别)
  - [19.4. 使用blob和URL.createObjectURL生成一个url](#194-使用blob和urlcreateobjecturl生成一个url)
- [20. URL.createObjectURL()](#20-urlcreateobjecturl)
  - [20.1. `URL.createObjectURL(blob)`和`FileReader.readAsDataURL(file)`的异同：](#201-urlcreateobjecturlblob和filereaderreadasdataurlfile的异同)
- [21. 文件和二进制数据对象](#21-文件和二进制数据对象)
- [22. fetch 发送2次请求的原因](#22-fetch-发送2次请求的原因)
- [23. 让坐标变化的2种方式](#23-让坐标变化的2种方式)
- [24. `requestAnimFrame`](#24-requestanimframe)
- [25. `onmouseenter`和`onmouseover`对比](#25-onmouseenter和onmouseover对比)
- [26. click 在 ios 上有300ms延迟，如何解决](#26-click-在-ios-上有300ms延迟如何解决)
- [27. PNG,GIF,JPG 的区别及如何选](#27-pnggifjpg-的区别及如何选)
- [28. 属性描述对象](#28-属性描述对象)
- [29. 注意img的`onerror`属性：](#29-注意img的onerror属性)
- [30. ajax解决浏览器缓存问题](#30-ajax解决浏览器缓存问题)
- [31. 学习资料](#31-学习资料)
...
#### 20.1. `URL.createObjectURL(blob)`和`FileReader.readAsDataURL(file)`的异同：
...
### 25. `onmouseenter`和`onmouseover`对比
